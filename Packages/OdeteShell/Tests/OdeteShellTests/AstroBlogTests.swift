// Os arquivos do modelo blog do create-astro vão inteiros aqui dentro, com as linhas longas deles.
...
struct AstroBlogTests {
    ...
    @Test func modeloBlogDoCreateAstro() async throws {
        ...
        #expect(
            home.contains(#"<link rel="canonical" href="https://example.com/""#),
            "o Astro.site não veio do config: \(diag)"
        )
        ...
        #expect(
            lista.contains("Markdown Style Guide") && lista.contains("Using MDX"),
            "o getCollection não listou: \(lista.prefix(1200))"
        )
        ...
        #expect(
            mdx.contains(#"onclick="alert(&#39;clicked!&#39;)""#),
            "o spread de props do HeaderLink não levou o onclick"
        )
        ...
        #expect(
            rss.contains("<title>Astro Blog</title>") && rss.contains("https://example.com/blog/first-post/"),
            "\(sem(rss))"
        )
